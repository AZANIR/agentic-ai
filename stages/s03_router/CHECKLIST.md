...
- [ ] `python -m stages.s03_router.check` — 32 зелених перевірок, 15 із них на режими відмови.
- [ ] `python -m stages.s03_router.decision` — сім ситуацій і відповідь на кожну.
- [ ] Зняв ліміт ревізій (вправа 2) і побачив, що червоніють **дві** перевірки, а не одна.
