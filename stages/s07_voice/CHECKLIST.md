...
- [ ] Можу сказати, чому p95 береться найближчим рангом, а не інтерполяцією.
...
- [ ] `python -m stages.s07_voice.run` — шість сцен; третю прочитав уважно.
- [ ] `python -m stages.s07_voice.check` — усі зелені; перевірок: 33, з них на режими відмови: 25.
- [ ] `python scripts/mutate.py s07 --expect` — числа у вправах збігаються з прогоном.
- [ ] Зробив вправу 4 і побачив, що відношення падає з 3.5x до 1.6x — тобто більша частина
      виграшу береться не з фрагментів.
...
- [ ] Можу назвати шість обмежень етапу — і жодне з них не сюрприз.
