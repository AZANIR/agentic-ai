...
1. **Постав Python 3.12 і прожени етап там.** CrewAI встановиться, і в таблиці з'явиться
   рядок із **ненульовою** надбавкою токенів. Порівняй його з LangGraph і скажи вголос, чому
   переможця немає.
