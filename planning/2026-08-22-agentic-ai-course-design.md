...
**Вирішено й виконано.** Копії чужих статей у репозиторії не лежать: вони переїхали в
`sources/`, яка стоїть у `.gitignore`. У публічний репозиторій іде лише наш власний код і
наші власні статті.
