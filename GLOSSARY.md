...
| <a id="price-of-assembly"></a>**Ціна складання** | Два числа в одній одиниці: виконувані рядки перехідників проти виконаних рядків етапів. Одне число без другого нічого не означає. Межа жанру — п'ята частина: за нею капстоун уже не збирає, а переписує |
...
| <a id="final-state"></a>**Фінальний стан** | Третє, що звіряє сценарій, після гілки й складу частин: що лишилось у пам'яті. Курс двічі ловив правильну відповідь, отриману хибним шляхом, — і обидва рази текст був бездоганний |
