...
Option 3 виглядає привабливо й ламається на першому ж перефразуванні. Але вона лишається
**запасним шляхом**: коли бюджет вичерпано, класифікація за ключовими словами дає гілку
без виклику моделі, і сервіс може чесно сказати, що працює в обмеженому режимі.
...
- Запасний шлях без моделі існує й задіюється при вичерпаному бюджеті.
