...
def get_client(demo_script: list[dict[str, Any]] | None = None) -> Any:
...
def get_model() -> str:
    ...
    return settings.llm_model or _FAKE_MODEL
...
def banner(client: Any) -> str:
    ...
    return f"[LLM] {settings.llm_base_url} · model={get_model()}"
