...
Скелет матеріалізовано; етапи 1–7 завершено. Сервіс розгортається за HTTPS.
...
| Етап 10 — капстоун | **готово**, 24 перевірки, 11 із них на режими відмови; 7 із 7 частин працюють, 166 виконаних рядків проти 19 перехідників (11 %) |
